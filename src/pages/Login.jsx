    ...
    <div className="min-h-screen bg-base flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="mt-4 bg-brand-light border border-app rounded-xl p-4 text-xs text-sub">
          ...
          <p className="mt-1">Staff: <code className="bg-card border border-app px-1.5 py-0.5 rounded text-brand">staff77</code> / <code className="bg-card border border-app px-1.5 py-0.5 rounded text-brand">staff77</code></p>
        </div>
      </div>
    </div>
  );
